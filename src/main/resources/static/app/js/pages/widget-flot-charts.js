...
$(function () {
    ...
    var interactive_plot = $.plot('#interactive', [getRandomData()], {
	  ...
	  tooltip: true,
      lines : {
        fill : '#ffd13f', //Converts the line chart to area chart
        color: '#ffd13f'
      },
	  tooltipOpts: {
            content: "Visit: %y"
    ...
    var donutData = [
      { label: 'Jan-Apr', data: 45, color: '#ef483e' },
      { label: 'May-Aug', data: 32, color: '#69cce0' },
      { label: 'Sep-Dec', data: 23, color: '#05b085' }
    ]
