...
function loadPosts(page_) {
    $.ajax({
        type: "GET",
        url: "/user/" + userId + "/posts/page/" + page_,
            ...
            if (posts.length == 0) {
                ...
                $.each(posts, function (i, postData) {
                    ...
                    if(postData.post.user.profileImg == null){
                        postDiv+='<a href="/user/' + postData.post.user.id + '/profile"><img class="avatar avatar-lg user-profile-image" src="/resources/images/profile.png" alt="..."></a>';
                    }else {
                        postDiv+='<a href="/user/' + postData.post.user.id + '/profile"><img class="avatar avatar-lg user-profile-image" src="/resources/users/' + postData.post.user.profileImg + '" alt="..."></a>';
                    }
